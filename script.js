...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Loop through the courses array and create HTML cards
    if (container) {
        ...
        courses.forEach(course => {
            ...
            // Create paragraph element for short description
            const paragraph = document.createElement('p');
            paragraph.className = 'short-desc';
            paragraph.textContent = course.ShortDesc.substring(0, 100) + '...'; // Display only a part of the short description
            ...
            readMoreBtn.addEventListener('click', function () {
                // Toggle visibility of the full short description
                paragraph.textContent =
                    paragraph.textContent === course.ShortDesc
                        ? course.ShortDesc.substring(0, 100) + '...'
                        : course.ShortDesc;
            });
